...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${SITE_URL}/genehmigungsfrei`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    { url: `${SITE_URL}/grz-rechner`, lastModified: now, changeFrequency: 'monthly', priority: 0.85 },
